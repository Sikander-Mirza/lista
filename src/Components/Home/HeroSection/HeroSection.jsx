...
import HeroBg from "../../../assets/Banners/BgImageNewlista.jpg";
import MobileBg from "../../../assets/Banners/BgImageNewlista.jpg";
        ...
        <>
            <section className='flex flex-col justify-center items-center'>
                ...
                >
                    ...
                    <div className="h-[200px] sm:h-[230px] md:h-[210px] lg:h-[260px] xl:h-[220px]" />
