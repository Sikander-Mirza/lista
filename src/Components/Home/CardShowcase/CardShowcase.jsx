...
It is a commercial real estate investor ecosystem designed to facilitate investor collaboration.`,
  ...
  <p className="text-[14px] font-Inter font-medium text-pretty text-Paracolor mt-2 sm:text-[13.5px] md:text-[13.5px] xl:text-[15px] min-[1780px]:!text-[16.5px] text-left w-full">
Newlista is not a brokerage, not a public listing portal, and not a service marketplace. It is a private commercial real estate investor network designed for active investors who want to connect with other investors, share off-market opportunities, build capital relationships, and form acquisition partnerships within a focused commercial real estate community built around collaboration and long-term partnerships.  </p>
</div>
       <div className="
  grid
  grid-cols-1
