                            ...
                            .map((item, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col w-[240px]" >
                                        <span onClick={() => { navigate(generatePropertyUrl(item.data)) }} className="text-[14px] sm:text-[14px] sm:leading-[17px] font-Urbanist font-semibold">{item.data.property_type === "Other" ? item.data.property_name + " " + item.data.city + "," + " " + item.data.state : item.title}</span>
