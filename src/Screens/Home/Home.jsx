    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center min-[400px]:px-5 sm:px-0 min-[1780px]:!px-28">
        ...
        >
          ...
          <div className={` grid sm:grid-cols-2 min-[890px]:!grid-cols-3 gap-5 md:max-w-[83%] lg:max-w-[84%] place-items-center z-50 relative ${status === "active" ? "" : "blur-md pointer-events-none select-none"}`}>
            <Suspense fallback={<SectionFallback />}>
              {filteredProperties.length === 0 ? (
                <div
                  className={`flex justify-center h-[60vh] items-center w-[100%] col-span-full relative ${status === "active" ? "" : "blur-xl"
                    }`}
                >
                ...
                <div
                  className={`flex justify-center h-[100vh] items-center w-[100%] col-span-full relative ${status === "active" ? "" : "blur-xl"
                    }`}
                >
