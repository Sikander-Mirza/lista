...
const ConfirmationModal = ({
  ...
  return (
    <div
      className={`fixed w-[100%] left-0  h-[100vh] top-0 overflow-y-hidden z-[999999999999] flex items-center bg-[#000000c2] bg-opacity-50 transition-opacity duration-300  ${
        isOpen ? "opacity-100 visible" : "opacity-0 invisible"
      }`}
    >
      <div
        className={`bg-white h-max rounded-lg shadow-lg w-full max-w-md mx-auto p-6 transform transition-all duration-300 ${
