    ...
    <div>
      ...
      <Suspense fallback={
        <div className="flex gap-2">
          <div className="bg-[#F3EEFF] w-[18%] h-12 rounded-[8px] animate-pulse"></div>
          <div className="bg-[#F3EEFF] w-[82%] h-12 rounded-md animate-pulse"></div>
        </div>
      }>
        <PhoneInput
          country={"us"}
          ...
          inputClass={`!bg-[#F3EEFF] !text-[#1d1d1d] !font-[600] !font-Urbanist !text-[14px] rounded-[6px] outline-none !w-[100%] !ml-20 sm:!ml-24 !h-12 !placeholder:text-black !placeholder:text-[13px] !rounded-md !pl-4 !border focus:!outline-none focus:!ring-none ${error ? '!border-red-500' : '!border-none'}`}
